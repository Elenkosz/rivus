...
def create_square_grid(origo_latlon=(48.26739, 11.66842), num_edge_x=1, num_edge_y=None, dx=100, dy=None, noise_prop=0.0, epsg=None, match=0):
    ...
    edf['Edge'] = edf.index
    # As for now rivus does this internally, and causes error:
    # But in the future it would make sense. (See Issue #1)
    # vdf.set_index('Vertex', inplace=True); edf.set_index('Edge', inplace=True)
